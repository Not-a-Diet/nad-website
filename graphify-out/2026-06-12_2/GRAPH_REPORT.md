# Graph Report - nad-website  (2026-06-12)

## Corpus Check
- 217 files · ~53,575 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2673 nodes · 3470 edges · 238 communities (202 shown, 36 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9740cf06`
...
## Communities (238 total, 36 thin omitted)
...
Cohesion: 0.18
Nodes (12): Blog Post view test suite, Strapi v5 dynamic zone pattern, Dynamic Page route test suite, fetchAPI util, normalizeParams, normalizePopulate, Strapi v5 Dot-Notation Populate Conversion, Home Page route test suite (+4 more)
...
Cohesion: 0.13
Nodes (22): getStrapiURL, HashScroller(), scrollToHash(), generateMetadata(), getGlobal, inter, RootLayout(), getStrapiURL() (+14 more)
...
Cohesion: 0.18
Nodes (13): capitalizeFirstLetter, componentResolver, Strapi __component UID to React Component Mapping, FALLBACK_SEO, getPageBySlug, RootRoute(), generateStaticParams(), PageRoute() (+5 more)
...
Cohesion: 0.30
Nodes (9): CategoryRoute (blog category page), Category Router, CategoryRoute(), fetchPostsByCategory(), generateMetadata(), generateStaticParams(), getCategoryBySlug(), fetchAPI() (+1 more)
...
Cohesion: 0.29
Nodes (6): build, env, main, ENABLE_EXPERIMENTAL_COREPACK, git, deploymentEnabled
...
Cohesion: 0.17
Nodes (23): generateMetadata (blog article page), getMetaData (blog article), PostRoute (blog article page), authOptions(), isNoindex(), safeFetch(), sharedAlternates(), sitemap() (+15 more)
...
Cohesion: 0.20
Nodes (9): Agent Guidelines for NAD Website Repository, Architecture, Fixed (Migration to v5 + Next.js 16), graphify, Key Data Flow, Known Issues & Tech Debt, Overview, Remaining Issues (+1 more)
...
Cohesion: 0.18
Nodes (11): favicon, allowedTypes, multiple, pluginOptions, required, type, pluginOptions, localized (+3 more)
...
Cohesion: 0.13
Nodes (12): layout(), BlogHeaders, BlogIndex(), getBlogHeaders(), getInitialArticles(), loadInitialData, loadMorePosts (pagination handler), Meta (+4 more)
...
Cohesion: 0.25
Nodes (7): collectionName, kind, options, draftAndPublish, increments, timestamps, pluginOptions
...
Cohesion: 0.33
Nodes (6): attributes, businessInfo, component, pluginOptions, repeatable, type
...
## Knowledge Gaps
- **1329 isolated node(s):** `name`, `private`, `packageManager`, `workspaces`, `dev` (+1324 more)
